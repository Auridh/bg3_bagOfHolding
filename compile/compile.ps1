...
divine -a convert-loca -g bg3 -s "$absPath/mod/Localization/Italian/BagOfHolding.xml" -d "$absPath/mod/Localization/Italian/BagOfHolding.loca";
divine -a convert-loca -g bg3 -s "$absPath/mod/Localization/Spanish/BagOfHolding.xml" -d "$absPath/mod/Localization/Spanish/BagOfHolding.loca";
